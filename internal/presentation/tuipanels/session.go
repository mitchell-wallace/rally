...
func demoEnrichments() map[int]demoEnrichment {
	return map[int]demoEnrichment{
		0: {summary: "Captured the baseline exported surface and confirmed the new TUI work can stay presentation-local.", classification: "analysis"},
		1: {summary: "Re-pointed all consumers to the new contract and verified the architecture guard remained clean.", classification: "implementation"},
		...
		3: {summary: "Extracted the process support package and kept the prototype wiring behind the CLI command.", classification: "implementation"},
	}
}

func cloneItems(items []tuicore.FeedItem) []tuicore.FeedItem {
