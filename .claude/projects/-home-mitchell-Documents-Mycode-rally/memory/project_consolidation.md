...
- Port rally's multi-agent support, laps/scout modes, self-update, install pipeline as runtime features
...
- Task structure: Externalize planning/issue tracking (rally's approach) via laps or similar, rally focuses on delegating work to agents — NOT gry's internalized Sprint/Phase/Task model
...
- Laps is the primary task backend, not a hard dependency
